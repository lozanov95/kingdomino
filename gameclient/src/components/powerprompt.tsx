...
export function PowerPrompt(
    ...
    return (
        <div className="status">
            ...
            <button className="font-bold text-xl px-5 mr-5" onClick={() => { handlePowerChoice(true) }}>Yes</button>
            <button className="font-bold text-xl px-5" onClick={() => { handlePowerChoice(false) }}>No</button>
        </div >
    )
}